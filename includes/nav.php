<nav>
    <ul>
        <?php
            ...
            if(isCurrentPage('individualWorkout.php')) echo '<li class="active"><a>'.getWorkoutName([$_GET['id']]).'</a></li>';
            ...
            if(isCurrentPage('individualExercise.php')) echo '<li class="active"><a>'.getExerciseName([$_GET['id']]).'</a></li>';
